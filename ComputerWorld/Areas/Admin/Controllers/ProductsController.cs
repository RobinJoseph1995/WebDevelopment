...
namespace ComputerWorld.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private readonly HostingEnvironment _hostingEnvironment;   //to save image in the server

        [BindProperty]         //it will automatically bind productsviewModel
        ...
        {
            var products = _db.Products.Include(m => m.ProductTypes).Include(m => m.SpecialTags);   //we are popululating product object
        ...
        {
            return View(ProductsVM);  //to get the drop down with special tags
        }
