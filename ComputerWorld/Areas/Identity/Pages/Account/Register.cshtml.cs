...
namespace ComputerWorld.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly RoleManager<IdentityRole> _roleManager;  //adding roles

        public RegisterModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<RegisterModel> logger,
            RoleManager<IdentityRole> roleManager,  //dependency injection for role manager
            IEmailSender emailSender)
        {
            ...
            _roleManager = roleManager;       // role manager assigned
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "You are not writing password carefully. Password does not match")]
